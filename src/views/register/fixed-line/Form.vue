    ...
    <layout v-else>
        ...
        <base-card :shadow="false" :cardFull="true">
            <template v-slot:header>
                <div class="titel-page">เจ้าหน้าที่ติดต่อกลับ<br />NT Fixed Line</div>
            </template>
            <template v-slot:body>
                <div class="py-2 px-6">
                    ...
                    <div class="form-group select-time">
                        ...
                        <div class="message-error" v-if="formDirty && selectedTime === ''">
                            กรุณาเลือกช่วงเวลาที่ประมาณการติดตั้ง
                        </div>
                    </div>
                </div>
                <div class="py-2 px-6">
                    ...
                    <div class="form-group">
                        ...
                        <base-input v-model="formData.village" placeholder="กรอกอาคาร/หมู่บ้าน" />
                    </div>
                    <div class="form-group">
                        <label>ถนน</label>
                ...
                <div class="py-2 px-6">
                    <!-- <div class="form-title">ความเร็วอินเทอร์เน็ตที่ต้องการ</div>
                    <div class="form-group">
                        <label>ความเร็วที่ต้องการ*</label>
                        <base-select-option
                            v-model="formData.package_id"
                            placeholder="เลือกแพ็กเกจ"
                            :error="formDirty && !formData.package_id"
            ...
            <template v-slot:footer>
                <div class="d-flex justify-center align-center pa-6">
                    <base-button
                        @onClick="onSubmit"
                        shadow
                        :label="btnLoading === true ? 'กำลังโหลด...' : 'เสร็จสิ้น'"
...
export default {
    ...
    watch: {
        ...
        'formData.prefix_optional'(val) {
            this.formData.prefix_optional = checkEmoji(val);
        },
        'formData.mobile'(val) {
    ...
    mounted() {
        document.title = 'เจ้าหน้าที่ติดต่อกลับ NT Fixed Line';

        gtag('config', process.env.VUE_APP_GTAG_CONFIG, {
            page_title: 'เจ้าหน้าที่ติดต่อกลับ NT Fixed Line',
        });
